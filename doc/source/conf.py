...
# -*- coding: utf-8 -*-
#
# diffpy.adpdf documentation build configuration file, created by
...
try:
    fullversion = version("diffpy.adpdf")
except Exception:
...
modindex_common_prefix = ["diffpy.adpdf"]
...
basename = "diffpy.adpdf".replace(" ", "").replace(".", "")
